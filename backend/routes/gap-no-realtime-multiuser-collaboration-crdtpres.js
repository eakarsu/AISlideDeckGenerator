...
const FEATURE_SLUG = 'no-realtime-multiuser-collaboration-crdtpres';
const FEATURE_TITLE = 'No real-time multi-user collaboration (CRDT/presence)';
const PROJECT = 'AISlideDeckGenerator';
