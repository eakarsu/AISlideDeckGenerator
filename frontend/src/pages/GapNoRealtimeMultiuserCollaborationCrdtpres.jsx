...
export default function GapNoRealtimeMultiuserCollaborationCrdtpres() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-realtime-multiuser-collaboration-crdtpres', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No real-time multi-user collaboration (CRDT/presence)</h1>
      <p style={{ color: '#666', marginBottom: 16 }}>AISlideDeckGenerator - Gap feature</p>
